...
{'corrupted': False,
 ...
 'y': 3}
    ...
    tab_location = models.IntegerField(blank = True, null = True)
    equipped = models.BooleanField(default = False, blank = True, null = False)
    char_stash = models.BooleanField(default = False, blank = True, null = False)
